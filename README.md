...
| ![Simple fire sensor board Image](https://solde.red/333047/image) |
| :----------------------------------------------------------: |
...
This repository contains all design files for Simple fire sensor board, organized as follows:
